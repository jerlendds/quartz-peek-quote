...
function renderHighlightedText(text3, highlight) {
  const index = highlight.length > 0 ? text3.indexOf(highlight) : -1;
  if (index < 0) {
    return text3.split(/\n{2,}/).map((paragraph2) => /* @__PURE__ */ u2("p", { children: paragraph2 }));
  }
  const before = text3.slice(0, index);
  const anchor = text3.slice(index, index + highlight.length);
  const after = text3.slice(index + highlight.length);
...
var PeekQuotes_default = ((opts) => {
  ...
  const Component = (props) => {
    const { text: text3, highlight } = getConfiguredText(props, options);
    return /* @__PURE__ */ u2(
      "div",
      {
        ...
        children: /* @__PURE__ */ u2("div", { class: "peek-quotes__shell", children: [
          ...
          /* @__PURE__ */ u2("div", { class: "peek-quotes__viewport", "data-peek-viewport": true, children: /* @__PURE__ */ u2("div", { class: "peek-quotes__document", "data-peek-document": true, children: renderHighlightedText(text3, highlight) }) })
        ] })
      }
    );
  };
...
export { ExampleEmitter, ExampleFilter, ExampleTransformer, PeekQuotes_default as PeekQuotes, init, initPeekQuotes };
